        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-link m-0 p-1 p-md-2 p-lg-3">
                        <a href="/">Beranda</a>
                    </li>
                    ...
                    <li class="nav-item dropdown mt-lg-2 mt-md-0">
                        ...
                        <ul class="dropdown-menu modif-drop mt-3">
                            <li>
                                <a class="dropdown-item text-wrap" href="/struktur">Struktur Organisasi</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-wrap" href="/visi-misi">Visi Misi</a>
                            </li>
                            <li>
                    ...
                    <li class="nav-item dropdown mt-lg-2 mt-md-0">
                        ...
                        <ul class="dropdown-menu modif-drop mt-3">
                            ...
                            <li>
                                <a class="dropdown-item text-wrap" href="/perpustakaan">Perpustakaan Hukum</a>
                            </li>
                        </ul>
                    </li>
                </ul>
