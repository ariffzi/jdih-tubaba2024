...
@section('content')
    ...
    <section class="page-galeri">
        ...
        <div class="content">
            ...
            <label for="pic-1" class="lightbox"><img src="/assets/img/banner.jpg" /></label>
            ...
            <label for="pic-3" class="lightbox"><img src="http://unsplash.it/800/600?image=22" /></label>
            ...
            <div class="grid">
                <label for="pic-1" class="grid-item"><img src="/assets/img/banner.png" /></label>
                <label for="pic-2" class="grid-item"><img src="http://unsplash.it/400/300?image=20" /></label>
                <label for="pic-3" class="grid-item"><img src="http://unsplash.it/400/300?image=22" /></label>
