                        ...
                        <div class="card">
                            ...
                            <a href="baca-berita">
                                <div class="txt-1 mt-md-2 mt-lg-3">
                                    ...
                                    Perspiciatis deserunt repudiandae expedita id quibusdam?
                                    Dolorem odit, esse ea autem illo corrupti voluptatibus
                                    accusamus magni quibusdam blanditiis ratione at dolore
                                    debitis!
                                </div>
                            </a>
                            <div class="d-flex txt-2 mt-2">
                                <div>
                                    <i class="bi bi-calendar2-event me-2"></i>12 Januari 2024
                                </div>
                                <div class="ms-2 me-2 text-black-50">|</div>
                                <div><i class="bi bi-eye me-1"></i> 145 Kali</div>
                            </div>
                        </div>
                    </div>
                </div>
