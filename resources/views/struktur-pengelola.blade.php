...
@section('content')
    <!-- ======================== judul pages ========================= -->
    <section class="margin-top pages-all pt-lg-3 pt-md-5 pt-5">
        <div class="container">
            <div class="head mb-2">
                <div class="row">
                    <div class="col-6 jud">Struktur Pengelola</div>
    ...
    <section class="margin-top">
        <div class="profil container">
            <div class="struktur">
                <div class="text-center bagan">
                    <div>BAGAN STRUKTUR ORGANISASI</div>
                    <div>BAGIAN HUKUM SEKRETARIAT DAERAH</div>
                    <div>KABUPATEN TULAG BAWANG BARAT</div>
                    <div>TAHUN 2024</div>
                </div>

                <div class="profil-struktur">
