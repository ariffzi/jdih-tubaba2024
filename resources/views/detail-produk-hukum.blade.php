          ...
          <div class="item">
            <div class="card p-lg-3">
              <a href="#">
                <img
                  class="img-fluid"
                  src="/assets/logo/surat_edaran.jpg"
                  alt=""
                />
              </a>
            </div>
          ...
          <div class="item">
            <div class="card p-lg-3">
              <a href="#">
                <img
                  class="img-fluid"
                  src="/assets/logo/keputusan_skpd.jpg"
                  alt=""
                />
              </a>
            </div>
          ...
          <div class="item">
            <div class="card p-lg-3">
              <a href="#">
                <img
                  class="img-fluid"
                  src="/assets/logo/produk_hukum_pusat.jpg"
                  alt=""
                />
              </a>
            </div>
          ...
          <div class="item">
            <div class="card p-lg-3">
              <a href="#">
                <img
                  class="img-fluid"
                  src="/assets/logo/produk_hukum_prov.jpg"
                  alt=""
                />
              </a>
            </div>
